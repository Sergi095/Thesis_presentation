...
app.layout = html.Div([
    ...
    dcc.Store(id='simulation-status', data='idle'),  # 'idle', 'running', or 'stopped'
        ...
        return [
            html.Div([
                html.Div([
                    ...
                    dcc.Input(id='prey-sensing-range', type='number', value=3, style={'width': '80%', 'padding': '5px', 'marginBottom': '5px'}),
                ...
                html.Div([
                    ...
                    html.Div(id='simulation-div', style={'textAlign': 'left', 'marginTop': '10px', 'fontSize': '1.2vw'}),
